...
import image1 from '../../../assets/product-xx99-mark-one-headphones/desktop/image-gallery-1.jpg'
import image2 from '../../../assets/product-xx99-mark-one-headphones/desktop/image-gallery-2.jpg'
import image3 from '../../../assets/product-xx99-mark-one-headphones/desktop/image-gallery-3.jpg'
import { options } from '../earphones/Yx1earphone'

function Xx99mark1() {
  

    const price: number = 1750;
  ...
  const dispatch = useDispatch();
    ...
    const [xx99i1, setXx99i1] = useState({
      id: "po59i8210x99i1",
    nameOfProduct: 'XX99 MK I',
    url: '/image-xx99-mark-one-headphones.jpg',
    amount: 1,
    price,
    fullPrice: price
    })
    ...
    const cartHandler = (e: React.FormEvent<HTMLElement>) => {
      ...
      dispatch(cartActions.addToCart(xx99i1))
  ...
  return (
    ...
    <Box sx={{display: 'flex', alignItems: 'center', flexDirection: {xs: 'column', md: 'row'}, mt: '7rem', justifyContent: 'center', gap: '5rem'}}>
        <Box className={classes.oneHeadphones} sx={{ borderRadius: '8px'}}></Box>
